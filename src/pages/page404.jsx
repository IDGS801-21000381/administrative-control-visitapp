  ...
  return (
    <main className="main-ed flex flex-col items-center justify-center h-screen text-center bg-gray-800 font-montserrat">
      <div className="bg-gray-700 p-8 rounded-lg shadow-lg">
        ...
        <h2 className="h2-ed text-2xl text-gray-200 mb-4">Error: 404 page not found</h2>
        <p className="p-ed text-gray-400 mb-6">Sorry, the page you're looking for cannot be accessed</p>
